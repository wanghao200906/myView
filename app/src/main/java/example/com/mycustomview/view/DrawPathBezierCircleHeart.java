...
public class DrawPathBezierCircleHeart extends View {
    private static final float C = 0.551915024494f;     // 一个常量，用来计算绘制圆形贝塞尔曲线控制点的位置  该值为半径在1的情况
    ...
    public DrawPathBezierCircleHeart(Context context) {
        this(context, null);

    }

    public DrawPathBezierCircleHeart(Context context, AttributeSet attrs) {
        super(context, attrs);
