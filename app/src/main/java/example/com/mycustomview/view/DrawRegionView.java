...
import example.com.mycustomview.base.CustomView;

/**
 * Created by wanghao on 2017/6/28.
 */

public class DrawRegionView extends  CustomView {
    ...
    public DrawRegionView(Context context) {
        this(context, null);
    }

    public DrawRegionView(Context context, AttributeSet attrs) {
        super(context, attrs);
