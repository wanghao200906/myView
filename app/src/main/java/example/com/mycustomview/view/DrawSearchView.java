...
/**
 * Created by wanghao on 2017/5/31.
 */

public class DrawSearchView extends View {

    private static final String TAG = "DrawSearchView";
    // 画笔
    ...
    public DrawSearchView(Context context) {
        this(context,null);
    }

    public DrawSearchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAll();
    }
...
//        path_srarch.addRect(oval1, Path.Direction.CW);

        RectF oval2 = new RectF(-100, -100, 100, 100);      // 外部圆环
        path_circle.addArc(oval2, 45, -359.9f);
//        path_circle.addRect(oval2, Path.Direction.CW);
    ...
    private void drawSearch(Canvas canvas) {
        ...
        switch (mCurrentState) {
            ...
            case SEARCHING:
                ...
                float start = (float) (stop - 110+mAnimatorValue);
//                float start = (float) (stop - 1);
                Log.d(TAG, "drawSearch stop : "+stop);
                Log.d(TAG, "drawSearch start : "+start);
